    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('F', 'Feminino'), ('M', 'Masculino'), ('O', 'Outro')], max_length=5, null=True)),
                ('cellphone', models.CharField(blank=True, max_length=255, null=True)),
                ('biography', models.CharField(blank=True, max_length=4095, null=True)),
